import type { ExcalidrawInitialElements } from "@/components/lexical/ui/excalidraw/ExcalidrawModal";
...
import ExcalidrawModal from "@/components/lexical/ui/excalidraw/ExcalidrawModal";
import ExcalidrawImage from "@/components/lexical/ui/excalidraw/ExcalidrawImage";
import styles from "@/components/lexical/ui/excalidraw/Excalidraw.module.scss";
...
const Excalidraw = ({ data, nodeKey }: Props) => {
  ...
  return (
    <Fragment>
      ...
      {elements.length > 0 && (
        <button
          ref={buttonRef}
          className={cx("excalidraw-button", { select: isSelected })}
        >
          <ExcalidrawImage
          ...
          {isSelected && (
            <div
              className={cx("image-edit-button")}
              role="button"
              tabIndex={0}
