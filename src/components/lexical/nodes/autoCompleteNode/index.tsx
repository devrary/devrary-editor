...
import { useLexicalAutoComplete } from "@/states/lexical/lexicalAutoComplete/LexicalAutoCompleteProvider";
import { uuid as UUID } from "@/components/lexical/plugins/autoCompletePlugin";
...
function AutocompleteComponent({
  ...
  const [suggestion] = useLexicalAutoComplete();
